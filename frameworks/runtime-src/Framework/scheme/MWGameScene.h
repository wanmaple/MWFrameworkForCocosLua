...
public:
    ...
    MW_SYNTHESIZE(double, _memoryWarningLine, getMemoryWarningLine, setMemoryWarningLine);
    MW_SYNTHESIZE_READONLY(MWDictionary *, _viewControllers, getViewControllers);
